...
namespace DataAccess.Migrations
{
    ...
    [Migration("20241003134005_InitialCreate")]
            ...
            modelBuilder.Entity("DataObject.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("af14ed60-5699-4172-ae56-16b32c274caf"),
                            RoleName = "Admin",
                            Status = "None"
                        },
                        new
                        {
                            RoleId = new Guid("ab9791ae-788f-4152-a259-b62a79ed99e0"),
                            RoleName = "Student",
                            Status = "None"
                        },
                        new
                        {
                            RoleId = new Guid("5481b121-4d13-4abb-aacd-a0ebf1a0bc33"),
                            RoleName = "Tutor",
                            Status = "None"
                        });
                });
