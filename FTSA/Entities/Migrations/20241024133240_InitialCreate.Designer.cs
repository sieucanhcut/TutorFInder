...
namespace Entities.Migrations
{
    ...
    [Migration("20241024133240_InitialCreate")]
            ...
            modelBuilder.Entity("Entities.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            LocationId = new Guid("ec2b13d3-78a6-4655-83a4-6130a33e37c7"),
                            CityOrProvince = "Da Nang",
                            District = "Hai Chau"
                        },
                        new
                        {
                            LocationId = new Guid("23499f3e-cfff-40ab-8611-ffeda0db2a37"),
                            CityOrProvince = "Da Nang",
                            District = "Thank Khe"
                        },
                        new
                        {
                            LocationId = new Guid("8726fe2e-192a-4459-a00e-cf93fe9fc180"),
                            CityOrProvince = "Da Nang",
                            District = "Son Tra"
                        });
                });
            ...
            modelBuilder.Entity("Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("f9011393-aba2-4d9d-bc51-7ebe56e89faa"),
                            RoleName = "Admin",
                            Status = "None"
                        },
                        new
                        {
                            RoleId = new Guid("b75fb7f6-80a2-452e-a404-1fbead5d9f3a"),
                            RoleName = "Student",
                            Status = "None"
                        },
                        new
                        {
                            RoleId = new Guid("c5391f19-7a4c-46a8-9447-14d8fb3c0754"),
                            RoleName = "Tutor",
                            Status = "None"
                        });
                });
