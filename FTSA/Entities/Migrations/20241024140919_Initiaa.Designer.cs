...
namespace Entities.Migrations
{
    ...
    [Migration("20241024140919_Initiaa")]
    partial class Initiaa
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            LocationId = new Guid("2725dcf3-2216-476c-a6f6-cc7d9b4b8c05"),
                            CityOrProvince = "Da Nang",
                            District = "Hai Chau"
                        },
                        new
                        {
                            LocationId = new Guid("d8bad377-4dcd-40bd-b4ea-7733b8ec4ef5"),
                            CityOrProvince = "Da Nang",
                            District = "Thank Khe"
                        },
                        new
                        {
                            LocationId = new Guid("26c57f2c-ec53-4d08-92c9-44416c3c9285"),
                            CityOrProvince = "Da Nang",
                            District = "Son Tra"
                        });
                });
            ...
            modelBuilder.Entity("Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("6d755edc-96ed-44c4-8df5-b8c7f2056352"),
                            RoleName = "Admin",
                            Status = "None"
                        },
                        new
                        {
                            RoleId = new Guid("2e0cad2b-e47b-4417-b664-927a79b6e2e0"),
                            RoleName = "Student",
                            Status = "None"
                        },
                        new
                        {
                            RoleId = new Guid("f6c6ca3e-c4b1-4d54-bbb7-aa46d6105c7f"),
                            RoleName = "Tutor",
                            Status = "None"
                        },
                        new
                        {
                            RoleId = new Guid("e65cc6f9-77fa-410d-8980-70d8f27063af"),
                            RoleName = "Blocked",
                            Status = "None"
                        });
                });
