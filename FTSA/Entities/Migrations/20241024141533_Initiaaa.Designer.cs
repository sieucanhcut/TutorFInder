...
namespace Entities.Migrations
{
    ...
    [Migration("20241024141533_Initiaaa")]
    partial class Initiaaa
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            LocationId = new Guid("1ce5c0d6-5acc-4a09-bf59-361df192ea00"),
                            CityOrProvince = "Da Nang",
                            District = "Hai Chau"
                        },
                        new
                        {
                            LocationId = new Guid("29095f8f-605a-4877-9f6c-1a800f6411eb"),
                            CityOrProvince = "Da Nang",
                            District = "Thank Khe"
                        },
                        new
                        {
                            LocationId = new Guid("7db94b62-a70b-49aa-a6aa-bb9e195b382b"),
                            CityOrProvince = "Da Nang",
                            District = "Son Tra"
                        });
                });
            ...
            modelBuilder.Entity("Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("a4b5dd68-eadc-4e28-9aeb-06919f16641a"),
                            RoleName = "Admin",
                            Status = "None"
                        },
                        new
                        {
                            RoleId = new Guid("f63cd496-d966-4989-887e-c9e69ec1e3ed"),
                            RoleName = "Student",
                            Status = "None"
                        },
                        new
                        {
                            RoleId = new Guid("69a02bf2-dbab-482d-a084-c938fd2a66de"),
                            RoleName = "Tutor",
                            Status = "None"
                        },
                        new
                        {
                            RoleId = new Guid("3e92dded-a10b-453a-9722-a3ca49600a07"),
                            RoleName = "Blocked",
                            Status = "None"
                        });
                });
